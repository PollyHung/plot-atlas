...
plot/<slug>/        812 entry pages
plot/<ID>/          812 redirect stubs, kept so old links survive
...
| | Before | After |
|---|---|---|
| Indexable documents | 1 | 895 |
| Bytes to read one entry | 3.7 MB | 6.4 KB median, 246 KB heaviest |
| Search index loaded | whole bundle | 159 KB (30 KB gzipped) |
...
| | |
|---|---|
| Catalogued, classified and given their own page | **812 / 812** |
